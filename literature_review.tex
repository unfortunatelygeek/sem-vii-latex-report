...
Benchmark dermatology datasets (ISIC 2018, SD-198) predominantly contain lighter skin tones, with ITA values concentrated between 34.8° and 48°, indicating severe underrepresentation of darker phototypes. \\

Groh et al. & 2021 &
Showed that CNN performance declines when diagnosing skin conditions on skin tones not represented in the training distribution, confirming phototype-related bias in dermatology AI. \\

Fitzpatrick17k (Dataset release) & 2021 &
Released a 16{,}577-image dermatology dataset with Fitzpatrick phototype labels derived from DermaAmin and Atlas Dermatologico to improve skin-tone diversity. \\

Pakzad et al. & 2025 &
Identified major quality issues in Fitzpatrick17k, including duplication, mislabeling, non-dermatological inclusions, and substantial variation in imaging conditions. \\

Abhishek et al. & 2025 &
Independently verified structural flaws in Fitzpatrick17k and quantified leakage, showing reduced classifier performance on darker phototypes. \\

DermaMNIST (pre-correction) & 2020 &
Released a 10{,}015-image dermatology classification dataset derived from HAM10000. \\

Abhishek et al., DermaMNIST-C & 2025 &
Produced a corrected version of DermaMNIST with lesion-level grouping to eliminate train–test leakage. \\

Abhishek et al., DermaMNIST-E & 2025 &
Extended DermaMNIST-C with additional ISIC images to increase diagnostic and phototype diversity in validation and test sets. \\

Abhishek et al., Fitzpatrick17k-C & 2025 &
Released a cleaned version of Fitzpatrick17k with improved annotation quality and lesion-level splits, showing higher balanced accuracy on darker skin types. \\

DermaCon-IN & 2025 &
Introduced a multiconcept-annotated dermatology dataset focused on Indian skin disorders and broader phototype representation. \\
\hline
\end{tabular}
\caption{Summary of relevant literature and dermatology datasets.}
\end{table}

For our work, we plan on utilizing the DermaCon-IN dataset, as it focuses on Indian skin types and has high quality annotations.~\cite{dermacon}
